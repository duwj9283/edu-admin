...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            <form id="formEditPerm" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea name="description" rows="5" class="form-control" required="">{{$description}}</textarea>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
...
<script>
    ...
    seajs.use('models/entrustModel', function(entrustModel) {
        $("#formEditPerm").on("submit", function(){
            entrustModel.updatePerm($(this).serialize(), function(){
