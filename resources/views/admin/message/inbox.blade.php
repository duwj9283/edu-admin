    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            <div class="m-b">
                ...
                <a href="{{url('admin/message/write')}}" class="btn btn-warning btn-outline m-l"><i class="fa fa-pencil"></i> 写消息</a>
            ...
            <table id="tblDataList" class="table table-striped table-hover">
                ...
                <tbody>
                    @foreach($rows as $row)
                    <tr data-id="{{$row->message_id}}" style="cursor:pointer;">
                        <td class="text-center">
                            <input type="checkbox" name="ids" value="{{$row->id}}" />
                        </td>
                        <td>{{$row->sender_name}}</td>
                        <td>{{$row->title}}</td>
                        <td><span class="label label-info">{{$viewState[$row->view_status]}}</span></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <small class="font-bold">发件人：</small><span class="label"><%sender_name%></span> 
                <small class="font-bold m-l">时间：</small><span class="label"><%created_at%></span>
            </div>
...
@section('pagescript')
<script>
    $("#side-menu li[rel='msg_inbox']").addClass("active")
        ...
        $("#btnDelete").on('click', function(){
            ...
            if(keyValue){
                dialog({
                    ...
                    ok: function(){
                        messageModel.inboxToTrash({"ids":keyValue}, function(data){
