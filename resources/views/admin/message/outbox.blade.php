    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <small class="font-bold">发送给</small>
                <span class="label"><%receiver_names%></span>
            </div>
...
@section('pagescript')
<script>
    $("#side-menu li[rel='msg_outbox']").addClass("active")
        ...
        $("#btnDelete").on('click', function(){
            ...
            if(keyValue){
                dialog({
                    ...
                    ok: function(){
                        messageModel.outboxToTrash({"ids":keyValue}, function(data){
