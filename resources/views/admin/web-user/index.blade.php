                ...
                <div class="row">
                    <div class="table-responsive ">
                        ...
                        <div class="col-sm-3">
                            <div class="m-b">
                                <div class="dropdown">
                                    <a href="/admin/webuser/add" class="btn btn-primary m-l-xs "> <i
                                                class="fa fa-plus"></i>
                                        新建
                                    </a>
                                    <a href="javascript:;" class="btn btn-warning m-l-xs js-import"> <i
                        ...
                        <div class="col-sm-3">
                            <form id="searchForm">
                                <div class="input-group">
                                    <input type="text" name="keyword" placeholder="手机号/邮箱/姓名"
                                           class="input-sm form-control" value="{{$keyword}}">
                        ...
                        <table id="tblDataList" class="table  table-hover">
                            ...
                            @foreach($lists as $key=> $value)
                                <tr data-id="{{$value['uid']}}">
                                    ...
                                    <td>{{$value['email']}}</td>
                                    <td>{{$value['sex']}}</td>
                                    <td>{{!empty($value['roles'])?implode(',',$value['roles']):''}}</td>
                                    <td>
                                        <a href="/admin/webuser/add?id={{$value['uid']}}"><i
                                                    class="fa fa-edit">编辑</i></a>
                                        @if($value['disable']==1)
                                            <a href="javascript:void(0)" class="js-disable" data-status="1"><i
                                                        class="fa  fa-check-circle">启用</i></a>
                                        @else
                                            <a href="javascript:void(0)" class="js-disable" data-status="0"><i
                                                        class="fa   fa-times-circle">禁用</i></a>
                                        @endif
                                        <a href="javascript:void(0)" class="role-set"><i
                                                    class="fa  fa-user">角色分配</i></a>
